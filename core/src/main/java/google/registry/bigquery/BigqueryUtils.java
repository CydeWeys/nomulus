...
public class BigqueryUtils {
  ...
  public static Instant fromBigqueryTimestampString(String timestampString) {
    return Instant.from(BIGQUERY_TIMESTAMP_PARSER.parse(timestampString));
  }
  ...
  public static String toBigqueryTimestamp(Instant dateTime) {
    return toBigqueryTimestamp(
        ChronoUnit.MICROS.between(Instant.EPOCH, dateTime), TimeUnit.MICROSECONDS);
  }
